...
class TestLogin(BaseTest):
    ...
    def test_main_screen_text_compare(self, data):
        allure.attach(body="test1 - text assertion", name="text attachment", attachment_type=allure.attachment_type.TEXT)
    ...
    def test_main_screen_text_hard_compare(self, data):
        allure.attach(body="test2 - text assertion", name="text attachment", attachment_type=allure.attachment_type.TEXT)
    ...
    def test_login_with_locked_user_data(self, data):
        allure.attach(body="test3 - error message", name="text attachment", attachment_type=allure.attachment_type.TEXT)
    ...
    def test_login_with_incorrect_data_and_check_error_messages(self, data):
        allure.attach(body="test4 - error message", name="text attachment", attachment_type=allure.attachment_type.TEXT)
        self.login_page.enter_user_name_and_password(data['username'], data['password'])
        self.login_page.click_login_btn()
        self.login_page.assert_error_message(data['error'])
    ...
    def test_login_with_correct_data(self, data):
        allure.attach(body="test5 - enter the site", name="text attachment", attachment_type=allure.attachment_type.TEXT)
        self.login_page.enter_user_name_and_password(data['username'], data['password'])
        self.login_page.click_login_btn()
